    ...
    public void testMain(Object[] args)
    {
        ...
        while (!TestContext.getRunningTestContext().isAborted())
        {
            try
            {
                ...
                Object o = ScriptPlayback.getLog().getClass().newInstance();
                ...
                File scriptLogFolder = new File(ScriptPlayback.getLog().getLogDirectory()).getParentFile();
                // Tell the HTMLLog code where to create its log folder.
                Reflection.executeMethod(o, LogExtensionAdapter.class.getCanonicalName(), "setLogDirectory", new Object[] {scriptLogFolder.getAbsolutePath() + File.separator + executionRequest.getName()});
                // Tell the HTMLLog code what name to put at the top of the HTML file
                Reflection.executeMethod(o, LogExtensionAdapter.class.getCanonicalName(), "setLogName", new Object[] {executionRequest.getName()});
                ...
                Log.rft.scriptStart(executionRequest.getName(), "java");
                //
                try
                {
