...
import resources.demoScripts.ObjectMapDemoHelper;
...
public class ObjectMapDemo extends ObjectMapDemoHelper
{
    ...
    public void testMain(Object[] args)
    {
        ...
        String objectMapFilePath = RationalTestScript.getCurrentProject().getLocation() + "\\demoScripts\\OMDemo.rftmap";
        //
        ...
        logInfo("Google search results text: " + gto5.getProperty(".text").toString());
        pto.kill();
    }
}
