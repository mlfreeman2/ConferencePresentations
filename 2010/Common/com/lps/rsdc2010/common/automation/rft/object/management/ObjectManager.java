...
import com.lps.rsdc2010.common.automation.rft.object.actions.Actions;
...
public abstract class ObjectManager
{
    ...
    protected final void loadObjectMap(String path)
    {
        ...
        {
            RationalTestScript.logError("Unable to find the object map file located at " + path);
        }
    }
    ...
    protected final void addItemToTable(String friendlyName, String...properties)
    {
        ...
        {
            RationalTestScript.logWarning("An odd number of property name/value entries were supplied for " + friendlyName + " in " + screenName);
        }
        ...
        do
        {
            ...
            catch (ObjectNotFoundException e)
            {
                if (attempts == numberOfActionTries - 1)
                {
                    ...
                    RationalTestScript.logError(error, Console.getScreenshot());
                }
            }
            ...
            catch (CoordinateOffScreenException e)
            {
                if (attempts == numberOfActionTries - 1)
                {
                    RationalTestScript.logError("Unable to click on " + friendlyName + " because it is off the screen", Console.getScreenshot());
                }
            }
            ...
            catch (UnregisteredObjectException e)
            {
                if (attempts == numberOfActionTries - 1)
                {
                    RationalTestScript.logError("Unable to click on " + friendlyName + " because it became unregistered", Console.getScreenshot());
                }
            }
            catch (UnableToPerformActionException e)
            {
    ...
    public String select(String friendlyName, String data)
    {
        ...
        do
        {
            ...
            {
                RationalTestScript.logError(e.getMessage(), Console.getScreenshot());
                return null;
            }
            catch (ObjectNotFoundException e)
            {
